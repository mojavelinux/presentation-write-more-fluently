...
#TODO# My name is Dan Allen...
// end::title[]

== Brain Hacks

// tag::retro[]
Last year, I was here at Devoxx Morocco offering seven ways to help you write fluently.
...
// tag::keys-intro[]
Hack #{counter:hack-idx-script}: Keep your fingers on the keys
// end::keys-intro[]
